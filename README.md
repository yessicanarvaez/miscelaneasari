...
- **GitHub** → publicación y compartición del proyecto  
...
4. Abrir `index.html` en el navegador (Chrome, Edge o Firefox).  
5. También se puede abrir directamente desde GitHub Pages si está publicado.  
...
- Formulario de contacto con envío de mensajes  
